...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    StudentEmail: Attribute.Email;
    StudentBOD: Attribute.Date;
    Gender: Attribute.Enumeration<['Male', 'Female']>;
    course: Attribute.Enumeration<['standard', 'gifted', 'EP']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTeacherTeacher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    TeacherID: Attribute.String;
    TeacherBOD: Attribute.Date;
    TeacherEmail: Attribute.Email;
    TeacherGender: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
